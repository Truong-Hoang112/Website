...
async function sendEmail(options) {
    ...
    try {
        ...
        console.log(`✓ Email đã gửi: ${options.to} - ${options.subject}`);
        return true;
    } catch (error) {
...
async function sendOrderEmail(order, user, items) {
    ...
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <div style="background: #007bff; color: white; padding: 20px; text-align: center;">
            ...
            <p style="margin: 5px 0 0;">Xác nhận đơn hàng #${order.payment_code}</p>
        </div>
        ...
        <div style="padding: 20px;">
            ...
            <table style="width: 100%; border-collapse: collapse;">
                <tr>
                    ...
                    <td style="padding: 5px 0;">#${order.payment_code}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="padding: 5px 0;"><span style="background: #ffc107; padding: 3px 10px; border-radius: 3px;">${statusText[order.status] || order.status}</span></td>
                </tr>
            </table>
            ...
            <p style="margin-top: 30px; text-align: center;">
                <a href="${siteUrl}/order/${order.id}" style="background: #007bff; color: white; padding: 12px 30px; text-decoration: none; border-radius: 5px; display: inline-block;">
        ...
        <div style="background: #f8f9fa; padding: 15px; text-align: center; font-size: 12px; color: #666;">
            <p style="margin: 0;">Email này được gửi tự động từ ${siteName}.</p>
            <p style="margin: 5px 0 0;">© ${new Date().getFullYear()} ${siteName}. All rights reserved.</p>
        </div>
    </div>
    `;
    ...
    <div style="font-family: Arial, sans-serif; max-width: 500px; margin: 0 auto;">
        ...
        <div style="padding: 30px; text-align: center;">
            ...
            <div style="background: #f8f9fa; padding: 20px; margin: 20px 0; border-radius: 10px;">
                ...
                <h2 style="margin: 10px 0; font-size: 2.5em; letter-spacing: 10px; color: #333;">${otp}</h2>
            </div>
        ...
        <div style="background: #f8f9fa; padding: 15px; text-align: center; font-size: 12px; color: #666;">
            <p style="margin: 0;">© ${new Date().getFullYear()} ${siteName}</p>
        </div>
    </div>
    `;
...
async function sendWelcomeEmail(user) {
    ...
    <div style="font-family: Arial, sans-serif; max-width: 500px; margin: 0 auto;">
        <div style="background: #28a745; color: white; padding: 20px; text-align: center;">
            <h1 style="margin: 0;">Chào mừng đến với ${siteName}!</h1>
        </div>
        ...
        <div style="padding: 30px; text-align: center;">
            ...
            <p style="margin-top: 30px;">
                <a href="${siteUrl}" style="background: #007bff; color: white; padding: 12px 30px; text-decoration: none; border-radius: 5px; display: inline-block;">
                    Bắt đầu mua sắm
                </a>
            </p>
        </div>
